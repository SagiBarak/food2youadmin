...
public class CaredOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference mRef = FirebaseDatabase.getInstance().getReference().child("Orders").child("Fixed");
        ...
        protected void populateViewHolder(NewOrdersViewHolder viewHolder, final Order model, int position) {
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FixedOrderDetailedFragment fixedOrderDetailedFragment = new FixedOrderDetailedFragment();
                    fixedOrderDetailedFragment.setArguments(args);
                    fixedOrderDetailedFragment.show(fragment.getFragmentManager(), "Detailed");
                }
            });
